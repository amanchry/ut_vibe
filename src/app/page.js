...
import { PlusCircle, X, Search, Heart, MapPin, Clock, ImageIcon, Trash2, ChevronLeft, ChevronRight, MoreVertical, Edit, Trash, ThumbsDown } from "lucide-react";
  ...
  return (
    <>
      ...
      <Flex height="100vh" pt="49px" align="stretch" direction="column">
        {/* Toggle Map View */}
        <div className="px-3 sm:px-6 pt-3 sm:pt-4 pb-2 flex items-center justify-between border-b border-gray-200 bg-white">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <button
              ...
              className={`hidden lg:flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm font-medium transition-all ${
                showMap
